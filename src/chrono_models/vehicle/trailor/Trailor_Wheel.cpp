...
// -----------------------------------------------------------------------------
// -----------------------------------------------------------------------------
Trailor_Wheel::Trailor_Wheel(const std::string& name, const WheelData& data) : ChWheel(name), m_data(data){}

// -----------------------------------------------------------------------------
// -----------------------------------------------------------------------------
void Trailor_Wheel::AddVisualizationAssets(VisualizationType vis) {
    ChWheel::AddVisualizationAssets(vis);
}

void Trailor_Wheel::RemoveVisualizationAssets() {
