...
/// @} vehicle_models_uaz
class CH_MODELS_API Trailor_LeafspringAxle : public ChLeafspringAxle {
  public:
    Trailor_LeafspringAxle(const std::string& name, const SuspensionData& data);
    ~Trailor_LeafspringAxle();
