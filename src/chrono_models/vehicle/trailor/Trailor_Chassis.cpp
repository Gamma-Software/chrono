...
// -----------------------------------------------------------------------------
// -----------------------------------------------------------------------------
Trailor_Chassis::Trailor_Chassis(const std::string& name, const ChassisData& data, bool fixed, ChassisCollisionType chassis_collision_type)
    ...
    m_has_mesh = true;
    m_vis_mesh_name = "Trailor_chassis_POV_geom";
    m_vis_mesh_file = "Trailor/chassis.obj";
    ...
    switch (chassis_collision_type) {
        ...
        case ChassisCollisionType::MESH:
            m_coll_mesh_names.push_back("Trailor/chassis.obj");
            break;
        default:
            break;
    }
