...
struct TireData
{
    ...
    std::string meshName = "Trailor_tire_POV_geom";
    std::string meshFile = "Trailor/Trailor_tire.obj";
};
...
class CH_MODELS_API Trailor_RigidTire : public ChRigidTire {
  public:
    Trailor_RigidTire(const std::string& name, const TireData& data, bool use_mesh = false);
    ~Trailor_RigidTire() {}
